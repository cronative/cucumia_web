...
class MasterCard extends GetResponsiveView<MatserListController> {
                ...
                RichText(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text:
                            productItem.created_on?.toString().substring(0, 10),
                        style: DefaultTextStyle.of(context).style.copyWith(
                              fontSize: 14,
                            ),
                      ),
  ...
  Widget _buildMasterProductsButton() {
    ...
    DateTime? Exdate = productItem.expires_on?.getDateTimeInUtc();
    return Padding(
      padding: EdgeInsets.only(
        left: Get.width * 0.005,
        right: Get.width * 0.005,
      ...
      child: Avdate.isAfter(Exdate!)
          ? Row(
              children: [
                ...
                //               width: 200,
                //               child: Text(
                //                   "This product was available on App from ${productItem.available_from?.getDateTimeInUtc().toString().substring(0, 10)} to ${productItem.expires_on?.getDateTimeInUtc().toString().substring(0, 10)}"),
                //             ),
                //           ],
                //         ),
                //       );
