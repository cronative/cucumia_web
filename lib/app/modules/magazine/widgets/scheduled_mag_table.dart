...
class ScheduledMagTable extends GetResponsiveView<MagazineController> {
  ScheduledMagTable({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return controller.allscheduledMagazine.isNotEmpty
        ? Padding(
            ...
            child: Obx(
              () => SingleChildScrollView(
                child: PaginatedDataTable(
                  ...
                  rowsPerPage: controller.allscheduledMagazine.isEmpty
                      ? 1
                      : controller.allscheduledMagazine.length < 10
                          ? controller.allscheduledMagazine.length
                          : 10,
                  columns: const [
                  ...
                  columnSpacing: 10,
                  source: DataSource(context, controller.allscheduledMagazine),
                ),
              ),
            ),
          )
