...
import 'package:cucumia_admin/app/modules/registration/views/widgets/step1.dart';
import 'package:cucumia_admin/app/modules/registration/views/widgets/step2.dart';
            ...
            children: [
                                    ...
                                    () => Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: ClipPath(
                                            clipper: regController.isStep1Completed.isFalse ? ArcClipper() : null,
                                            child: Container(
                                              color: Theme.of(context).cardTheme.color,
                                              child: Padding(
                                                padding: EdgeInsets.fromLTRB(8, 8, regController.isStep1Completed.isFalse ? 38 : 8, 8),
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    regController.isStep1Completed.isTrue
                                                        ? const CircleAvatar(
                                                            maxRadius: 15,
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(4.0),
                                          child: ClipPath(
                                            clipper: regController.isStep1Completed.isTrue ? ArcClipper() : null,
                                            child: Container(
                                              color: Theme.of(context).cardTheme.color,
                                              child: Padding(
                                                padding: const EdgeInsets.fromLTRB(8, 8, 38, 8),
                                                child: Column(
                                                  mainAxisSize: MainAxisSize.min,
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
              ...
              AnimatedSwitcher(
                  ...
                  child: selectedOption.value == Option.step2
                      ...
                      : Step2(
                          onLogInSelected: () => selectedOption.value = Option.step2,
                        )),
            ],
          ),
        ),
