import 'package:cucumia_admin/app/modules/registration/controllers/registration_controller.dart';
import 'package:cucumia_admin/app/modules/registration/views/registration_view.dart';
                                      ...
                                      Expanded(
                                        ...
                                        child: LabeledTextField(
                                          ...
                                          textfield: FormTextInputField(
                                            readOnly: controller2.isEditing.isFalse,
                                            controlName: 'shop_name',
                                            hintText: 'Lucy',
                                            onEditingComplete: () => _form.focus('shop_city'),
                                            keyboardType: TextInputType.emailAddress,
                                            textInputAction: TextInputAction.next,
                                            validationMessage: (control) => {
                                              ValidationMessage.required: 'Shop Name can not be empty',
                                            },
                                          ),
                                        ),
                                      ),
                                      ...
                                      Expanded(
                                        ...
                                        child: LabeledTextField(
                                            ...
                                            textfield: FormTextInputField(
                                              ...
                                              hintText: 'Kochi',
                                              onEditingComplete: () => _form.focus('partner_type'),
                                              keyboardType: TextInputType.phone,
                                              textInputAction: TextInputAction.next,
                                              validationMessage: (control) => {
                                                ValidationMessage.required: 'Shop City can not be empty',
                                              },
                                            )),
                                      ),
                                    ],
                                      ...
                                      Expanded(
                                        ...
                                        child: LabeledTextField(
                                            ...
                                            textfield: FormTextInputField(
                                              ...
                                              hintText: 'Owner',
                                              onEditingComplete: () => _form.focus('owner_name'),
                                              keyboardType: TextInputType.text,
                                              textInputAction: TextInputAction.next,
                                              validationMessage: (control) => {
                                                ValidationMessage.required: 'form can not be empty',
                                              },
                                            )),
                                      ),
                                      const SizedBox(
                                      ...
                                      Expanded(
                                          ...
                                          child: LabeledTextField(
                                            ...
                                            textfield: FormTextInputField(
                                              ...
                                              onEditingComplete: () => _form.focus('owner_email'),
                                              keyboardType: TextInputType.text,
                                              textInputAction: TextInputAction.next,
                                              validationMessage: (control) => {
                                                ValidationMessage.required: 'Owner Name can not be empty',
                                              },
                                            ),
                                          )),
                                    ],
                                      ...
                                      Expanded(
                                        ...
                                        child: LabeledTextField(
                                            ...
                                            textfield: FormTextInputField(
                                              ...
                                              textInputAction: TextInputAction.next,
                                              validationMessage: (control) => {
                                                ValidationMessage.required: 'Owner email can not be empty',
                                              },
                                            )),
                                      ),
                                      const SizedBox(
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Row(
                                          children: [
                                            MaterialButton(
                                              onPressed: () {
                                                controller2.isStep1Completed.value = true;
                                              },
                                              child: Container(
                                                width: 100,
                                ...
                                children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: LabeledTextField(
                                          ...
                                          textfield: FormTextInputField(
                                            ...
                                            onEditingComplete: () => _form.focus('shop_contact'),
                                            keyboardType: TextInputType.emailAddress,
                                            textInputAction: TextInputAction.next,
                                            validationMessage: (control) => {
                                              ValidationMessage.required: 'Shop Full Address can not be empty',
                                            },
                                          ),
                                        ),
                                      ),
                                      ...
                                      Expanded(
                                        ...
                                        child: LabeledTextField(
                                            ...
                                            textfield: FormTextInputField(
                                              ...
                                              textInputAction: TextInputAction.next,
                                              validationMessage: (control) => {
                                                ValidationMessage.required: 'Shop Contact Number can not be empty',
                                              },
                                            )),
                                      ),
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      const Expanded(flex: 10, child: Center(child: Text("OR"))),
                                      Expanded(
                                        flex: 25,
                                      ...
                                      Expanded(
                                        ...
                                        child: LabeledTextField(
                                            ...
                                            textfield: FormTextInputField(
                                              ...
                                              hintText: '10 : 00 AM',
                                              onEditingComplete: () => _form.focus('shop_closing'),
                                              keyboardType: TextInputType.text,
                                              textInputAction: TextInputAction.next,
                                              validationMessage: (control) => {
                                                ValidationMessage.required: 'Shop Opening can not be empty',
                                              },
                                            )),
                                      ),
                                      SizedBox(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: DropdownButton<String>(
                                          ...
                                          items: <String>['English-US', 'English-US', 'English-US', 'English-US'].map((String value) {
                                          ...
                                          children: [
                                            Obx(
                                              () => Checkbox(
                                                ...
                                                value: controller2.isRestaurant.value,
                                                onChanged: (bool? value) {
                                                  controller2.isRestaurant.value;
                                                },
                                              ),
                                            ),
