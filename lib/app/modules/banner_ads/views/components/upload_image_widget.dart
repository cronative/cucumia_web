...
class uploadPic extends GetResponsiveView<BannerAdsController> {
  double radius;
  RxString imageurl;
  RxBool loading;
  uploadPic(this.radius, this.imageurl, this.loading, {Key? key})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    BannerAdsController controller = Get.find<BannerAdsController>();
